...
export type PlanEvidenceItem = {
  ...
  source: "business_discovery" | "goals" | "customer_voice" | "external_intelligence" | "weekly_briefing" | "smart_uploads" | "business_reasoning" | "business_learning_engine" | "opportunity_engine";
};
