export const AuditActions = {
  ...
  SEARCH_CONSOLE_OAUTH_CONNECTED: "search_console_oauth.connected",
  SEARCH_CONSOLE_DISCONNECTED: "search_console.disconnected",
  SEARCH_CONSOLE_CONNECTION_VERIFICATION_FAILED: "search_console.connection.verification_failed",
  SEARCH_CONSOLE_SYNC_STARTED: "search_console.sync.started",
  SEARCH_CONSOLE_SYNC_COMPLETED: "search_console.sync.completed",
  SEARCH_CONSOLE_SYNC_FAILED: "search_console.sync.failed",
  SMART_UPLOAD_DOCUMENT_UPLOADED: "smart_upload.document.uploaded",
  SMART_UPLOAD_DOCUMENT_DELETED: "smart_upload.document.deleted",
  SMART_UPLOAD_EXTRACTION_STARTED: "smart_upload.extraction.started",
  SMART_UPLOAD_EXTRACTION_COMPLETED: "smart_upload.extraction.completed",
  SMART_UPLOAD_EXTRACTION_FAILED: "smart_upload.extraction.failed",
