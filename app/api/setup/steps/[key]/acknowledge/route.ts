...
import { acknowledgeCustomerSetupStepForCurrentUser } from "@/lib/customer-setup/service";
...
export async function POST(
  ...
  const result = await acknowledgeCustomerSetupStepForCurrentUser({ stepKey: key });
  if (!result.ok) {
