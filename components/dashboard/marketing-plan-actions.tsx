...
import { refreshMarketingPlan } from "@/lib/marketing-planner-client";

export function MarketingPlanRefreshButton() {
  ...
  async function handleRefresh() {
    ...
    const { error: refreshError } = await refreshMarketingPlan();
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      ...
      >
        {refreshing ? "Generating Plan..." : "Refresh Plan"}
      </button>
