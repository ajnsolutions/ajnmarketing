...
import { refreshMarketingAgentTasks } from "@/lib/marketing-agent-client";

export function MarketingAgentRefreshButton() {
  ...
  async function handleRefresh() {
    ...
    const { error: refreshError } = await refreshMarketingAgentTasks();
