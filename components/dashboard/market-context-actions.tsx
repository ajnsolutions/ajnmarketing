...
import { refreshMarketContextBrief } from "@/lib/market-context-client";

export function MarketContextRefreshButton() {
  ...
  async function handleRefresh() {
    ...
    const { error: refreshError } = await refreshMarketContextBrief();
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      ...
      >
        {refreshing ? "Refreshing Context..." : "Refresh Market Context"}
      </button>
